...
### For MacOS or unix-based systems:
                ...
                python3 jpeg2twb.py slides_path tableau_file_name [-f --fixed height width] [-o --open]
...
### For Windows OS:
                ...
                python3 jpeg2twb.exe slides_path tableau_file_name [-f --fixed height width] [-o --open]
