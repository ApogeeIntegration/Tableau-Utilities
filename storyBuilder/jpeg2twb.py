...
parser = argparse.ArgumentParser(description = "This should hold a description.")
...
## If Tableau file path exists, show alert message asking if OK to overwrite. If not, abort the script.
if os.path.exists(tableau_file_path) == True:

  MsgBox = tk.messagebox.askquestion("Tableau File Exists", "Tableau file already exists, do you with to overwrite?")
  ...
  if MsgBox == 'yes':
    ...
    <workbook original-version='18.1' source-build='2019.4.0 (20194.19.1010.1202)' source-platform='mac' version='18.1' xmlns:user='http://www.tableausoftware.com/xml/user'>
      ...
      <dashboards>""")
        ...
        # Create a dashboard for each slide images exported from PDF file
        for slide in range(1,(len(os.listdir('slides')))):
        ...
        <dashboard name='Dashboard {slide_num}'>
          ...
          <zones>
            <zone h='100000' id='4' type='layout-basic' w='100000' x='0' y='0'>
              <zone h='97090' id='3' is-centered='0' is-scaled='1' param='{image_folder_path}/Slide{slide_num}.jpeg' type='bitmap' w='98316' x='842' y='1455'>
                <zone-style>
              ...
              <zones>
                <zone h='100000' id='6' type='layout-basic' w='100000' x='0' y='0'>
                  <zone h='97090' id='5' param='vert' type='layout-flow' w='98316' x='842' y='1455'>
                    <zone fixed-size='280' h='97090' id='3' is-centered='0' is-fixed='true' is-scaled='1' param='{image_folder_path}/Slide{slide_num}.jpeg' type='bitmap' w='98316' x='842' y='1455'>
                      <zone-style>
                        <format attr='border-color' value='#000000' />
                        <format attr='border-style' value='none' />
                        <format attr='border-width' value='0' />
        ...
        </dashboard>""".format(image_folder_path = image_folder_path , slide_num = slide, end_id = id_unique_end, sizing_string = sizing_string))
        ...
        for slide in range(1,(len(os.listdir(image_folder_path)))):
    ...
    tk.messagebox.showinfo("Abort", "Aborting tasking: please provide a different tableau file name.")


# If optional argument is true, open the Tableau file immediately, otherwise create the .twb file unopened.
if open_file_after_creation == True:
